...
if __name__ == '__main__':
    ...
    for i in range(VIRTUAL_ROBOT_COUNT+REAL_ROBOT_COUNT):
        TOPIC[i] = rospy.Publisher("/comms_nexus"+str(i),ROS_Task, queue_size=0)
        rospy.Subscriber("/comms_nexus"+str(i), ROS_Task, cb,queue_size=10000)
    ...
    # print(GRAPH.currentPositions)


    # for i in range(VIRTUAL_ROBOT_COUNT):
    #     if not (np.array_equal(GOALS[i], GRAPH.currentPositions[i])):
    #         print(i)
    #     else:
    #         print(GOALS[i], GRAPH.currentPositions[i])
    ...
    # GRAPH = GRAPH(actionList)

    # G2 = GraphTD(taskList, START)
    # GRAPH = Graph(taskList, START)
    ...
    # for i in GRAPH.graph:
    #     if not np.array_equal(set(GRAPH.taskDict[i].preqs), set(G2.taskDict[i].preqs)):
    #         print(i, GRAPH.taskDict[i].preqs, G2.taskDict[i].preqs)
    # for i in G2.graph:
    #     if not np.array_equal(set(GRAPH.taskDict[i].preqs), set(G2.taskDict[i].preqs)):
    #         print(i, GRAPH.taskDict[i].preqs, G2.taskDict[i].preqs)
